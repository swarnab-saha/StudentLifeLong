...
<div class="d-flex justify-content-center mt-5">
    ...
    <div class="container mt-5">
      ...
      <p>We are looking for a Full Stack Developer responsible for developing systems and 
        a suite of web based software products.</p>
    ...
    <div class="container desktop-job mt-5">
      <form action="insert-full-stack-developer-job.php" method="post">
