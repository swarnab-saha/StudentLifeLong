    ...
    <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-4 col-md-5 col-sm-6 col-8">
                <form class="form-bg" action="insert-employee-salary.php" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        title="Search Employee Id" onkeyup="noSpace(this)" 
                    ...
                    <div class="mb-3">
                        <label class="form-label mb-0" for="employee-salary"><b>Salary</b><span 
                        class="text-danger">*</span></label>
                        <input  class="form-control" type="text" 
                        name="employee-salary" id="employee-salary" onkeyup="numberOnly(this)" 
                        title="Enter Salary" placeholder="Enter Salary" maxlength="10" required>
                    </div>
...
<?php 
    if($department_name == 'Admin'){
        ...
        echo '
        <script>
            document.getElementById("admission-title").innerHTML = "Student LifeLong | Employee";
        </script>'; 
    } 
    else if($department_name == 'HR'){
        ...
        echo '
        <script>
            document.getElementById("hr-title").innerHTML = "Student LifeLong | Employee";
        </script>'; 
    } 
    else if($department_name == 'Finance'){
        ...
        echo '
        <script>
            document.getElementById("finance-title").innerHTML = "Student LifeLong | Employee";
        </script>'; 
    }   
    mysqli_close($mysqli);
    $msg = "";
