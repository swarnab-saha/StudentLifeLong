...
<div class="d-flex justify-content-center mt-5">
    ...
    <div class="container mt-5">
      <h3 class="text-center">Cyber Security Expert</h3>
      <h4 class="mt-5">About the Role</h4>
      <p>We are looking for a Cyber Security Expert responsible for developing systems and a suite 
        of web based software products.</p>
    ...
    <div class="container desktop-job mt-5">
      <form action="insert-cyber-security-expert-job.php" method="post">
