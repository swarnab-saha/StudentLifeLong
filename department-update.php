    ...
    <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-4 col-md-5 col-sm-6 col-8">
                <form class="form-bg" action="update-department.php" method="post">
                    <div class="mb-3">
                        <h4 class="text-center field-top">Department</h4>
                    </div>
                    <div class="mb-3">
                        <input class="form-control" type="text" list="idsuggestions" 
                        id="suggestions" name="suggestions" placeholder="Search Department Id" 
                        title="Search Department Id" onkeyup="noSpace(this)" 
                        onkeypress="numberText(this)"  maxlength="10" required>
                        <datalist id="idsuggestions">
                            <?php
                                $mysqli = new mysqli(DB_HOST,DB_USER,DB_PASSWORD,DB_DATABASE);
                                $qury = "SELECT * FROM department";
                                if($result=$mysqli->query($qury)){
                                    if(mysqli_num_rows($result)>0){
