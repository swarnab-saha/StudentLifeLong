...
<?php 
    ...
    if($department_name == 'Admin'){
        ...
        echo '
        <script>
            document.getElementById("admin-title").innerHTML = "Student LifeLong | My Profile";
        </script>'; 
    }   
    else if($department_name == 'Admission'){
        ...
        echo '
        <script>
            document.getElementById("admission-title").innerHTML = "Student LifeLong | My Profile";
        </script>'; 
    }
    else if($department_name == 'HR'){
        ...
        echo '
        <script>
            document.getElementById("hr-title").innerHTML = "Student LifeLong | My Profile";
        </script>'; 
    }
    else if($department_name == 'Finance'){
        ...
        echo '
        <script>
            document.getElementById("finance-title").innerHTML = "Student LifeLong | My Profile";
        </script>'; 
    }  
?>