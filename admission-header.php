...
<head>
    ...
    <title id="admission-title"></title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid link-color">
            <a class="navbar-brand" href="admission-index.php">Student LifeLong</a>
            ...
            <div class="collapse navbar-collapse nav-right" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        ...
                        href="admission-index.php">Home</a>
                    </li>            
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu scrollable-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="student-entry.php">Student</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" 
                        ...
                        <ul class="dropdown-menu scrollable-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="student-view.php">Student</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" 
                        ...
                        <ul class="dropdown-menu scrollable-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="student-update.php">Student</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="apply-by-students.php">
                            Apply by Students</a></li>
