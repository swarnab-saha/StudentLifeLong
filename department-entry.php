    ...
    <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-4 col-md-5 col-sm-6 col-8">
                <form class="form-bg" action="insert-department.php" method="post">
                    <div class="mb-3">
                        <h4 class="text-center field-top">Department</h4>
                    </div>
                    <div class="mb-3">
                        <label class="form-label mb-0" for="department-id"><b>Id</b><span 
                        class="text-danger">*</span></label>
                        <input  class="form-control text-capitalize" type="text" 
                        name="department-id" id="department-id" onkeyup="noSpace(this)"     
                        onkeypress="numberText(this)"  title="Enter Department Id" 
                        placeholder="Enter Department Id" maxlength="10" required>
                    </div>
                    <div class="mb-3">
                        ...
                        title="Enter Department Name" placeholder="Enter Department Name" 
...
<?php 
    if($department_name == 'Admin'){
        ...
        echo '
        <script>
            document.getElementById("admission-title").innerHTML = "Student LifeLong | Department";
        </script>'; 
    } 
    else if($department_name == 'HR'){
        ...
        echo '
        <script>
            document.getElementById("hr-title").innerHTML = "Student LifeLong | Department";
        </script>'; 
    } 
    else if($department_name == 'Finance'){
        ...
        echo '
        <script>
            document.getElementById("finance-title").innerHTML = "Student LifeLong | Department";
        </script>'; 
    }        
?>